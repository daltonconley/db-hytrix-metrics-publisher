...
public class ElasticMetricsPublisherCommand implements HystrixMetricsPublisherCommand {
	...
	public ElasticMetricsPublisherCommand(String prefix, MetricFilter metricFilter, HystrixCommandMetrics metrics, MetricRegistry metricRegistry) {
	...
	private ElasticMetricsReporter startReporter(MetricRegistry registry) throws Exception {
