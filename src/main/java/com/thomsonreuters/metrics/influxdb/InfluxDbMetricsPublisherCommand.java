...
public class InfluxDbMetricsPublisherCommand implements HystrixMetricsPublisherCommand {
	...
	public InfluxDbMetricsPublisherCommand(String prefix, MetricFilter metricFilter, HystrixCommandMetrics metrics, MetricRegistry metricRegistry) {
	...
	private ScheduledReporter startReporter(MetricRegistry registry) throws Exception {
